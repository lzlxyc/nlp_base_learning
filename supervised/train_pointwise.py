...
parser.add_argument("--model", default='/data1/linzelun/workspace/pretrained_model_torch/bert-base-chinese', type=str, help="backbone of encoder.")
...
def train():
    ...
    metric_accuracy = evaluate.load('./metrics/accuracy')
    ...
    metric = evaluate.combine({"accuracy":metric_accuracy, "f1":metric_f1, "precision":metric_precision, "recall":metric_recall})
